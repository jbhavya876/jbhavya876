...
<div align="center">
  ...
  **Smart Contract Developer | Cryptography Researcher | Protocol Engineer**
...
Backend engineer and security researcher building cryptographically secure, scalable systems for the future of governance, identity, and defense.

- 🔭 Engineering trust-verifiable and privacy-preserving architectures using blockchain and cryptography
- 🧱 Founder of **AlterBlock** — building nation-scale, post-quantum secure digital infrastructure
- 🛡️ Deep interest in zero-knowledge systems, post-quantum cryptography, and protocol design
- 🎯 I architect systems that stand the test of time, scale, and computation
...
- Reviewed NIST PQC standardization and hybrid migration strategies
- Proposed backend-oriented PQC implementation framework for real-world systems
...
**Stack:** `Circom` `SnarkJS` `Zero-Knowledge Proofs`

### ⚡ ElectraX
Geospatial optimization engine integrating AI and smart contracts for EV charging station deployment.  
**Stack:** `Solidity` `AI/ML` `Geospatial Analysis`

### 🎬 Ebbix
Decentralized content streaming platform with IPFS-backed storage and Ethereum micropayments.  
**Stack:** `IPFS` `Ethereum` `Web3.js` `React.js`

### 🔒 ZK-Comms *(Work in Progress)*
Privacy-preserving communication protocol leveraging zk-SNARKs and off-chain authentication.  
**Stack:** `Circom` `zk-SNARKs` `WebRTC`
...
- 🚀 **Always asking:** *Can this scale globally? Can it survive a quantum world?*
...
- 🛰️ **AlterBlock**: Trust-verifiable blockchain infrastructure for national-scale systems
- 🔐 Designing digital identity systems fortified by PQC and ZK proofs
- 🤖 Innovating at the intersection of AI and backend resilience for mission-critical systems
- 💼 **Long-term goal**: Protocol engineering in blockchain R&D or national security organizations
...
*The next era demands truth, integrity, and resilience — not just speed.*
